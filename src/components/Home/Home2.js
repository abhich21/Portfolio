          ...
          <Col md={12} className="home-about-social" data-aos="fade-up">
            ...
            <ul className="home-about-social-links">
              <li className="social-icons">
                <a
                  href="mailto:abhich2109@gmail.com?subject=subject"
                  target="_blank"
                  rel="noreferrer"
                ...
                <br /> <br />
                <div> abhich2109@gmail.com</div>
              </li>
              <li className="social-icons">
                <a
                  href="https://github.com/abhich21"
                  target="_blank"
                  rel="noreferrer"
                  className="icon-colour  home-social-icons"
                >
              ...
              <li className="social-icons">
                <a
                  href="https://www.linkedin.com/in/abhishek-choudhary-06856a230/"
                  target="_blank"
                  rel="noreferrer"
                  className="icon-colour  home-social-icons"
                >
